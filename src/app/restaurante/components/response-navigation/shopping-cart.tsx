...
const ShoppingCart = ({
    ...
    const { products, addOneProduct, subProduct, removeProduct, clear } =
        useFavStore();
    ...
    const totalCost = dishes.reduce(
        (sum, dish) => sum + (dish.dish_price || 0) * dish.quantity,
        0
    );
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <Link
                                            href={`/restaurante/${dish.restaurant_link}/${dish.language_code}/${dish.category_link}/${dish.dish_link}`}
                                            passHref
                                        >
                                            <Typography
                                                component="a"
